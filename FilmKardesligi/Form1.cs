...
namespace FilmKardesligi
{
    public partial class Form1 : Form
    {
        ...
        {
            string filmAd = txtFilmAdi.Text.Trim();
        ...
        private void FormuResetle()
        {
            ...
            btnIptal.Hide();
            btnEkle.Text = "EKLE";
            lstFilmler.Enabled = btnDüzenle.Enabled = btnSil.Enabled = true;
            txtFilmAdi.Focus();
        }
        ...
        private void btnDüzenle_Click(object sender, EventArgs e)
        {
            ...
            txtFilmAdi.Text = duzenlenen.FilmAd;
            // checkboxları seçtir
            for (int i = 0; i < clbTur.Items.Count; i++)
            {
            ...
            btnIptal.Show();
            btnEkle.Text = "KAYDET";
            lstFilmler.Enabled = btnDüzenle.Enabled = btnSil.Enabled = false;
        }
