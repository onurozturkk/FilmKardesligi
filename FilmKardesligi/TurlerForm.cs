...
namespace FilmKardesligi
{
    public partial class TurlerForm : Form
    {
        ...
        private void FormuResetle()
        {
            ...
            txtTurAd.Width += 80;
            btnIptal.Hide();
            lstTurler.Enabled = btnDüzenle.Enabled = btnSil.Enabled = true;
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Silmek için önce bir öğe seçiniz!");
                return;
            }
        ...
        private void btnDüzenle_Click(object sender, EventArgs e)
        {
            if (lstTurler.SelectedIndex < 0)
            {
                MessageBox.Show("Düzenlemek için önce bir öğe seçiniz!");
                return;
            }
            ...
            txtTurAd.Width -= 80;
            btnIptal.Show();
            lstTurler.Enabled = btnDüzenle.Enabled = btnSil.Enabled = false;
        }
